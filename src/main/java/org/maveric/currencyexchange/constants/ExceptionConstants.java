...
public class ExceptionConstants {
    ...
    public static final String CREDENTIALS_CHECK_EXCEPTION_MESSAGE = "Invalid email or password.";
    public static final String ACCOUNT_ALREADY_EXISTS_EXCEPTION_MESSAGE = "Can't create Account, Account already Exists!";
}
